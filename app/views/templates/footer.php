  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 SMK PEMBINAAN IDOL DAN VTUBER INDONESIA BOGOR</strong>
      All rights reserved.
  </footer>
...
<!-- DataTables  & Plugins -->
<script src="<?= urlTo('/public/adminlte/plugins/datatables/jquery.dataTables.min.js
')?> "></script>
<script src="urlTo('/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js')?> "></script>
<!-- sweetalert2 -->
